...
<div class="navbar navbar-inverse">
	<div class="container">
		...
		<ul class="nav navbar-nav">
			<li class="active"><a href="list.do">자료실 목록보기</a></li>
			<li><a href="${pageContext.request.contextPath }/cafe/list.do">카페 글 목록보기</a></li>
		</ul>		
		<c:choose>
...
<div class="container">
	...
	<a class="btn btn-primary btn-xs" href="<insertfo></insertfo>rm.do"><i class="glyphicon glyphicon-upload"></i> 파일 올리기</a>
	<h3>업로드된 파일 목록입니다.</h3>
