...
<div class="navbar navbar-inverse">
	<div class="container">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="list.do">카페 글 목록보기</a></li>
		</ul>		
		<c:choose>
...
<div class="container">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Cafe List</li>
	</ol>
	
	<a class="btn btn-primary btn-xs" href="insertform.do"><i class="glyphicon glyphicon-pencil"></i> 새글작성</a>
	<h3>카페 글 목록입니다.</h3>
